## Generated SDC file "Analog_Memory_System_2023_DE0.out.sdc"
...
create_clock -name {RST} -period 1000.000 -waveform { 0.000 500.000 } 
create_clock -name {CLK_IN} -period 10.000 -waveform { 0.000 5.000 } 
