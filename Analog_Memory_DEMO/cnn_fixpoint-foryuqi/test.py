...
if __name__ == "__main__":
    ...
    folderOut = '/Users/xxxx/Desktop/Workplace/Code/1d_cnn_fixpoint-foryuqi/1D_CNN_dataset'
    ...
    model = Net().to(device)
    model.load_state_dict(torch.load(('/Users/xxxx/Desktop/Workplace/Code/1d_cnn_fixpoint-foryuqi/ckpt/1d_cnn.pt'), map_location='cpu'))
